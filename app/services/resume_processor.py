...
class ResumeProcessor:
        ...
        try:
            ...
            if self.langchain_available:
                try:
                    ...
                    raise ResumeMatcherException(f"AI parsing failed. Please check the file content or try again later. Error: {str(e)}")
            else:
                logger.error("LangChain agents not available")
                raise ResumeMatcherException("AI service is not available. Please check configuration.")
    ...
    # Rule-based extraction methods removed in favor of AI-only processing with robust error handling
